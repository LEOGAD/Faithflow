...
try {
  if (process.env.FIREBASE_SERVICE_ACCOUNT_JSON) {
    ...
    try {
      ...
      db = admin.firestore();
      console.log('Firebase initialized successfully with SERVICE_ACCOUNT_JSON.');
    } catch (parseError) {
      console.error('CRITICAL: Failed to parse FIREBASE_SERVICE_ACCOUNT_JSON. Make sure it is valid JSON.', parseError.message);
      initLocalDb();
    }
